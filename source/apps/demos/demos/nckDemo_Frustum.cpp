...
void Demo_Frustum::Load(){
    ...
    font->Load("script://font_ubuntu.txt");
}
...
void Demo_Frustum::Render(float dt){
    ...
    font->Draw(10, 20, std::string("Checked: ") + Math::IntToString(stats.GetCheckedObjects()));
    font->Draw(10, 44, std::string("Rendered: ") + Math::IntToString(stats.GetRenderedObjects()));
