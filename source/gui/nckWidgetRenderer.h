...
public:
    ...
    virtual void Label(float x,float y, const std::string & text,float size,
...
public:
    BlenderWidgetRenderer(Graph::Device * dev, ShapeRenderer * shp, Font * font);
    ...
    void Label(float x,float y, const std::string & text,float size,
